 ...
 * @author issqn
 */
public class FramePeriodoSimei extends javax.swing.JDialog {
    ...
    public FramePeriodoSimei(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setTable(){
        ...
        for (int i=0;i<dados.size();i++){
            ...
            f.execute("INSERT INTO periodoSimei VALUES (null "
                    + ",'" + c.getCNPJCompleto() + "'"
                    + ",'" + aux.substring(8, 16) + "'"
                    + ",'" + aux.substring(16, 24) + "' "
                    + ",'" + aux.substring(24, 25) + "' "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FramePeriodoSimei.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FramePeriodoSimei dialog = new FramePeriodoSimei(new javax.swing.JFrame(), true);
