 ...
 * @author issqn
 */
public class FrameEventoSimples extends javax.swing.JDialog {
    ...
    public FrameEventoSimples(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        for (int i = 8; i < 14; i++) {
    ...
    public void setTable() {
        ...
        for (int i = 0; i < dados.size(); i++) {
            ...
            f.execute("INSERT INTO eventoSimples VALUES (null "
                    + ",'" + c.getCNPJCompleto() + "'"
                    + ",'" + aux.substring(8, 9) + "'"
                    + ",'" + aux.substring(9, 12) + "' "
                    + ",'" + aux.substring(12, 20) + "' "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameEventoSimples.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrameEventoSimples dialog = new FrameEventoSimples(new javax.swing.JFrame(), true);
